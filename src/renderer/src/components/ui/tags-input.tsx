		...
		return (
			...
			>
				<div
					...
					dir={dir}
					className={cn(
						"flex shadow-sm items-center flex-wrap gap-1 p-1 rounded-lg bg-background overflow-hidden   ring-1 ring-muted  ",
						{
				...
				>
					...
					<Input
						...
						className={cn(
							"outline-0 shadow-none border-none h-7 min-w-fit flex-1 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-0 placeholder:text-muted-foreground px-1",
